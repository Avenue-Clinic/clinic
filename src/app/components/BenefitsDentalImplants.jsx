...
const BenefitsDentalImplants = ({ dictionary }) => {
  ...
  const FeatureCard = ({ title, description }) => (
    <div className="flex gap-6 pl-4">
      ...
      <div>
        <h3 className="text-[20px] leading-[29px] font-semibold mb-1">
          {title}
        </h3>
      ...
      <div className="container px-8 mx-auto">
        <div className="max-w-[1290px] mx-auto">
          <div className={`text-left mb-[20px] ${isRTL ? 'rtl' : ''}`}>
            <h2 className="text-[30px] md:text-[36px] lg:text-[46px] leading-[42px] lg:leading-[55px] font-bold mb-6 text-[var(--primary)]">
              {benefits?.title}
            </h2>
            <p className="text-[16px] leading-[29px] font-normal max-w-[900px] mb-10 text-[var(--secondary-text)]">
              {benefits?.description}
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-[25px] text-[var(--primary)]">
