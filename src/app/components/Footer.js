        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <Link href={`/${locale}`} className="flex items-center mb-6">
              <Image src="/images/logo.png" alt="Medico" width={100} height={50} className="filter brightness-0 invert" />
            </Link>
            <p className="text-gray-300 mb-6">
              Expert dental care at affordable costs in Istanbul, providing top-quality treatments for your smile's health and beauty.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href={`/${locale}/treatments/surgical-dentistry`} className="text-gray-300 hover:text-white hover:underline">
                  Surgical Dentistry
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href={`/${locale}/faq`} className="text-gray-300 hover:text-white hover:underline">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/testimonials`} className="text-gray-300 hover:text-white hover:underline">
                  Testimonials
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-4">
              <p className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 text-[#00a9a7]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                </svg>
                <span className="text-gray-300">
                  123 Dental Street, Istanbul, Turkey
                </span>
              </p>
              <p className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 text-[#00a9a7]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
